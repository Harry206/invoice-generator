...
const MainPage = () => {
  ...
  useEffect(() => {
    if (editInvoice) {
      const normalizedInvoice = {
        ...
        billing: editInvoice.billing ?? {
          name: "",
          address: "",
          phone: "",
        },

        shipping: editInvoice.shipping ?? {
          name: "",
          address: "",
          phone: "",
        },
      ...
      setInvoiceTitle(normalizedInvoice.title || "Invoice");
    }
  }, [editInvoice]);
  ...
  const handleTemplateClick = (templateId) => {
    ...
    navigate("/preview", { state: { editMode: !!editInvoice } });
  };
